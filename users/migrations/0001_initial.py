    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('language', models.CharField(choices=[('kr', 'Korean'), ('jp', 'Japananese'), ('en', 'English')], default='', max_length=2)),
                ('currency', models.CharField(choices=[('won', 'Korean Won'), ('yen', 'Japan Yen'), ('usd', 'Dollar')], default='', max_length=5)),
